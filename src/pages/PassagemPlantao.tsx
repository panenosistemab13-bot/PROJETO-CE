          ...
          <div className="flex items-center space-x-3.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-300 mt-0.5 font-medium">
                Quadro Integrado de Monitoramento de Ocorrências em Trânsito, Transição de Turno & Atualizações &bull; Grupo 3corações
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0c1017]/90 border border-[#243147]/90 rounded-2xl p-12 text-center text-slate-400 shadow-2xl backdrop-blur-xl">
            <div className="flex flex-col items-center justify-center space-y-2">
              ...
              <p className="text-xs text-slate-500">
                Clique em "+ Nova Ocorrência" para cadastrar uma nova ocorrência.
              </p>
            </div>
          </div>
        ) : viewMode === 'list' ? (
